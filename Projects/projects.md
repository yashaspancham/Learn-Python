...
### Cloud (AWS/Azure/GCP)
1. [Done]**S3 File Uploader:** Script to upload a local file to an S3 bucket using Boto3. 
2. [Done]**EC2 Instance Lister:** Program to list all running cloud instances and their IDs.
3. [Done]**IAM User Auditor:** List all IAM users and their last login dates.
